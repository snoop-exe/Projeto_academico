...
if __name__ == '__main__':
    ...
    while True:
        ...
        if tipo_usuario == 'Aluno':
            ...
            carga_horaria = vca.cadastro_horas(id_aluno,conexao)
            while True:
                ...
                if opcao == '1':
                    ...
                    id_turma = int(df_materias.iloc[0]['id_turma'])
                    if df_materias is not None and not df_materias.empty:
                        print("Matérias disponíveis para matrícula: \n")
                        print(df_materias[['Escolha','NOME','NOME_PROFESSOR','TIPO','CH']].to_string(index=False))
                    else:
                    ...
                    if confirmar.lower() == 's':
                        ...
                        for _, row in materias_selecionadas.iterrows():
                            ra.realizar_matricula(id_aluno, id_turma,row['ID_MATERIA'],ch_materia,carga_horaria,conexao)
